...
import { adaptiveGradientDescent, objectiveFunctionMZC, gradient } from '../gradient_descent';
...
describe('gradient descent', () => {
  ...
  describe('functions for MZC', () => {
    it('should compute objective function for MZC correctly', () => {
      expect(objectiveFunctionMZC([0, 0, 0], P, gamma)).toEqual(1.0);
      expect(objectiveFunctionMZC([0.5, 0, 0], P, gamma)).toEqual(2.0);
      // Result value taken from python
      expect(objectiveFunctionMZC([.5, .5, 0], P, gamma)).toBeCloseTo(1.8424029756098448, 20);
      // Result value taken from python 
      expect(objectiveFunctionMZC([.5, .75, 0], P, gamma)).toBeCloseTo(2.23606797749979, 20);
    });
